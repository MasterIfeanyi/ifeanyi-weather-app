    ...
    return (
      <>
        <div className="card">
            ...
            <input placeholder="search" value={city} onChange={(e) => setCity(e.target.value)}  type="text" className="search-bar" />
            ...
            {/* <img src="https://openweathermap.org/img/wn/04n.png" alt="" class="icon" /> */}
                ...
                <>
                    <div className="weather loading">
                        <h2 className="city">Weather in {result.name}</h2>
                        ...
                        <div className="wind">Wind speed: {result.wind.speed} km/hr</div>
                    </div>
                </>
            ) : ("")}
        </div>
